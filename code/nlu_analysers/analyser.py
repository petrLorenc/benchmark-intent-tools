...
class Analyser(object):
    ...
    def sort_dict(my_dict):
        ...
        return [OrderedDict(sorted(my_dict.items(), key=lambda item: my_sort.index(item[0])))]
    ...
    def write_json(file, content):
        ...
        with open(file, "w") as f:
            json.dump(content, f, sort_keys=False, indent=4, separators=(',', ': '), ensure_ascii=False)
